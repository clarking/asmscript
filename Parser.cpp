 ...
 */
	...
	[[nodiscard]]  Error ParseOperand(std::unique_ptr<Operand> &operand) {
		const CodePos pos = GetPos();
		switch (GetTag()) {
			case TokenTag::RegRax:
				operand = std::make_unique<RegisterOperand>(Register::rax, pos);
				break;
			case TokenTag::RegRbx:
				operand = std::make_unique<RegisterOperand>(Register::rbx, pos);
				break;
			case TokenTag::RegRcx:
				operand = std::make_unique<RegisterOperand>(Register::rcx, pos);
				break;
			case TokenTag::RegRdx:
				operand = std::make_unique<RegisterOperand>(Register::rdx, pos);
				break;
			case TokenTag::RegRsi:
				operand = std::make_unique<RegisterOperand>(Register::rsi, pos);
				break;
			case TokenTag::RegRdi:
				operand = std::make_unique<RegisterOperand>(Register::rdi, pos);
				break;
			case TokenTag::RegRbp:
				operand = std::make_unique<RegisterOperand>(Register::rbp, pos);
				break;
			case TokenTag::RegR8:
				operand = std::make_unique<RegisterOperand>(Register::r8, pos);
				break;
			case TokenTag::RegR9:
				operand = std::make_unique<RegisterOperand>(Register::r9, pos);
				break;
			case TokenTag::RegR10:
				operand = std::make_unique<RegisterOperand>(Register::r10, pos);
				break;
			case TokenTag::RegR11:
				operand = std::make_unique<RegisterOperand>(Register::r11, pos);
				break;
			case TokenTag::RegR12:
				operand = std::make_unique<RegisterOperand>(Register::r12, pos);
				break;
			case TokenTag::RegR13:
				operand = std::make_unique<RegisterOperand>(Register::r13, pos);
				break;
			case TokenTag::RegR14:
				operand = std::make_unique<RegisterOperand>(Register::r14, pos);
				break;
			case TokenTag::RegR15:
				operand = std::make_unique<RegisterOperand>(Register::r15, pos);
				break;
	...
	[[nodiscard]]  Error ParseAssignment(Statements &statements) {
		...
		switch (GetTag()) {
			case TokenTag::Equals:
				isShorthand = false;
				break;
			case TokenTag::PlusEquals:
				op = Operation::Add;
				break;
			case TokenTag::MinusEquals:
				op = Operation::Sub;
				break;
			case TokenTag::StarEquals:
				op = Operation::Mul;
				break;
			case TokenTag::SlashEquals:
				op = Operation::Div;
				break;
			case TokenTag::PercentEquals:
				op = Operation::Mod;
				break;
			case TokenTag::AmpersandEquals:
				op = Operation::And;
				break;
			case TokenTag::PipeEquals:
				op = Operation::Or;
				break;
			case TokenTag::CaretEquals:
				op = Operation::Xor;
				break;
			default:
